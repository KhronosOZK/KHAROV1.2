const sections = [
  { t: "About Caro", b: "Caro is a marketplace connecting London private hire vehicle (PHV) drivers with vetted, TfL-licensed rental companies. Caro operates the marketplace, matching, and payment flow, and orchestrates specialist partners for insurance, claims and support. Caro is not an insurer and does not provide credit." },
  ...
  { t: "Insurance", b: "Insurance quotes are provided for comparison via Quotezone. Standard personal motor policies exclude hire and reward. Any policy you take must properly cover private hire use. Caro facilitates quotes and payment but the insurance contract is between you and the insurer." },
  { t: "Payments & deposits", b: "All payments are processed through Caro. Deposits are held securely and released after return, subject to the agreed handover condition record. Going around the platform to pay an operator directly may void cover and protections." },
  ...
  { t: "Your rights (UK GDPR)", b: "You can request access to, correction of, or deletion of your personal data at any time by contacting privacy@caro.co.uk. Where processing is based on consent, you can withdraw it at any time in your account settings." },
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mt-10 bg-white border border-slate-200 rounded-2xl p-6 text-sm text-[#64748B]">
        Questions about your data? Email <a href="mailto:privacy@caro.co.uk" className="text-[#047857] font-semibold">privacy@caro.co.uk</a>.
      </div>
    </main>
  );
}
