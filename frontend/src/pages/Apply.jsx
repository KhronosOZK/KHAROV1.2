        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-white rounded-[22px] p-6 sm:p-8 ring-1 ring-slate-200/70">
            ...
            {step === 2 && (<div>
              ...
              <p className="text-[15px] text-[#4A564F] mt-2 mb-6">The same details insurers ask for. Enter them once and we reuse them on every application after this.</p>
              <div className="space-y-4">
            ...
            <div className="flex gap-3 mt-8">
              ...
              {step < 3 ? (
                ...
                <Button onClick={submit} className="rounded-full bg-[#0B6B4F] hover:bg-[#095B43] text-white flex-1" data-testid="apply-submit">Send application</Button>
              )}
            </div>
          </div>
        </div>
