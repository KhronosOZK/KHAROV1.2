  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <div className="flex items-center gap-3 mb-8">
        <div className="w-11 h-11 rounded-2xl bg-emerald-50 flex items-center justify-center"><Heart className="w-6 h-6 text-[#047857]" /></div>
      ...
      {items.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center">
          ...
          <Button onClick={() => navigate("/")} className="mt-6 rounded-full bg-[#047857] hover:bg-[#065F46] text-white">Browse cars <ArrowRight className="w-4 h-4 ml-2" /></Button>
        </div>
      ) : (
